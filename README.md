...
`wget https://raw.githubusercontent.com/laishzh/openvpn-install/master/openvpn-install.sh --no-check-certificate -O openvpn-install.sh; bash openvpn-install.sh`
